#!/usr/bin/env python3
"""
A04: Analytical decomposition of the per-factor identity correction.
...
def main():
    t0 = time.time()
    pr("=" * 72)
    pr("A04: ANALYTICAL DECOMPOSITION OF c₂")
    ...
    for bits in [32, 64]:
        ...
        pr(f"    This explains why A04 measured c₂ ≈ 0.284 ≠ π²/36 ≈ 0.274")
